...
This assumes you are using the KGateway mobile app per the manufacturer's instructions.<br>
...
This assumes you are using the KBeacon mobile app per the manufacturer's instructions.<br>
...
### TLM Data
Recall this transmits iBeacon device signal strength, battery level, and device temperature.<br>
